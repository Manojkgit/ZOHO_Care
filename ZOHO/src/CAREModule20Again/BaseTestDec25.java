...
public class BaseTestDec25 {
	...
	public void Add_Customer_screenShot(){
		...
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//Add_Customer_screenShot//"+FileName));
		}
		catch(Exception e){
	...
	public void NIWO_Created_Successfully_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//NIWO_Created_Successfully_ScreenShot//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
	...
	public void Add_Product_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//Add_Product_ScreenShot//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
	...
	public void GLK_Customer_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//GLK_Customer_ScreenShot//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
	...
	public void NewCareDashBoard_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//NewCare_DashBoard//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
	...
	public void AgencyDashBoard_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//AgencyDashBoard_ScreenShot//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
	...
	public void AgencyDashBoard_FR_WO_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//FR_WO_Complete_ScreenShot//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
	...
	public void FR_WO_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//FR_WO_ScreenShot//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
	...
	public void FTR_And_NFTR_SR_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//FTR_And_NFTR_SR_ScreenShot//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
	...
	public void FTR_NFTR_SR_Multi_Room_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//FTR_NFTR_SR_Multi_Room_ScreenShot//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
	...
	public void FR_WO_Multi_Room_ScreenShot(){
		...
		File screenSrc = ((TakesScreenshot)dr).getScreenshotAs(OutputType.FILE);
		try{
			FileUtils.copyFile(screenSrc, new File(System.getProperty("user.dir")+"//FR_WO_Multi_Room_ScreenShot//"+FileName));
		}
		catch(Exception e){
			System.out.println(e.getMessage());
			e.printStackTrace();
